...
export const levers = [
...

  {
    ...
    headlines: [
      ...
      'Informal recycling sector faces formalization pressure — Kosovo\'s entire 3% recycling rate at risk',
    ],
    revealOrder: [
      ['eu'],
      ['mmphi', 'klmc'],
...

  {
    ...
    headlines: [
      ...
      'Mayor Rama declares state of emergency — contracts private operators who also fail to do the job',
